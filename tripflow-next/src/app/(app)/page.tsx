...
const MOCK_TRIPS = [
  {
    ...
    departureDate: '2026-10-12T00:00:00Z',
  },
  {
    id: 2,
    ...
    collaboratorAvatars: [
      ...
      'https://i.pravatar.cc/150?u=marco',
      'https://i.pravatar.cc/150?u=elena',
      'https://i.pravatar.cc/150?u=lorenzo'
    ],
    accentColor: 'var(--color-green)',
    departureDate: '2026-06-05T00:00:00Z',
  },
]
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <Dashboard
        trips={MOCK_TRIPS}
        onGenerateTrip={() => setIsWizardOpen(true)}
        onQuickExpense={() => {
          // TODO: Create proper Quick Expense modal
          alert('Quick Expense feature coming soon! This will open a modal to add expenses quickly.')
        }}
      />
